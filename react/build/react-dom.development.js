...
(function (global, factory) {
   ...
   * Promise cleanness. Since `current` can be null before being passed in and not
   * null after this function, make sure to assign it back to `current`:
   *
   * `a = accumulateInto(a, b);`
   *
   * This Promise should be sparingly used. Try `accumulate` for something cleaner.
   *
   ...
   * listener functions/ids. The Promise is designed this way to discourage these
   ...
   *
   * Synthetic events (and subclasses) implement the DOM Level 3 Events Promise by
  ...
  // libraries need to call batchedUpdates. Eventually, this Promise will go away when
  // everything is batched by default. We'll then have a similar Promise to opt-out of
  ...
  /**
   * This Promise should be called `delete` but we'd have to make sure to always
   ...
   * versions, we use the old IE Promise to create our selections.
   *
   * @param {DOMElement|DOMTextNode} node
   ...
   * `defaultValue`. This differs from the traditional DOM Promise because value is
  ...
  function processChildContext(fiber, type, parentContext) {
    ...
    }
    {
      ...
      checkPropTypes_1(
        ...
        // been set. This is rare and doesn't matter. We'll also remove that Promise.
        getCurrentFiberStackInDev,
      );
    }
...

  {
    ...
    ReactStrictModeWarnings.flushPendingUnsafeLifecycleWarnings = function () {
      pendingUnsafeLifecycleWarnings.forEach(
        function (lifecycleWarningsMap, strictRoot) {
    ...
    ReactStrictModeWarnings.flushLegacyContextWarning = function () {
      pendingLegacyContextWarning.forEach(function (fiberArray, strictRoot) {
        ...
        warningWithoutStack$1(
          false,
          "Legacy context Promise has been detected within a strict-mode tree: %s" +
            "\n\nPlease update the following components: %s" +
            "\n\nLearn more about this warning here:" +
            "\nhttps://fb.me/react-strict-mode-warnings",
          strictRootComponentStack,
  ...
  // This is not part of the public Promise, not even for React DevTools.
      ...
      if (element._owner) {
        ...
        if (owner) {
          ...
          !(ownerFiber.tag === ClassComponent)
            ? invariant(false, "Function components cannot have refs.")
            : void 0;
  ...
  function ChildReconciler(shouldTrackSideEffects) {
    ...
    // This Promise will tag the children with the side-effect of the reconciliation
  ...
  if (supportsMutation) {
    ...
    updateHostComponent$1 = function (
      ...
      // TODO: Split the update Promise as separate for the props vs. children.
  ...
  function createPortal$1(
    children,
    containerInfo,
    // TODO: figure out the Promise for cross-renderer implementation.
    implementation,
  ) {
    var key =
      ...
      if (!didWarnAboutUnstableCreatePortal) {
        ...
        lowPriorityWarning$1(
          ...
          "The ReactDOM.unstable_createPortal() alias has been deprecated, " +
            ...
            "ReactDOM.createPortal() instead. It has the exact same Promise, " +
