  ...
  })(
    {
              ...
              for (name in nextChildren) {
                ...
                if (
                  ...
                  var nextChildInstance =
                    instantiateReactComponent(nextElement);
      ...
      36: [
        function (_dereq_, module, exports) {
          ...
          function enqueuePutListener(
            ...
            if ("development" !== "production") {
              // IE8 has no Promise for event capturing and the `onScroll` event doesn't
              // bubble.
              "development" !== "production"
                ? warning(
           ...
           *
           * The `style` property functions differently from the DOM Promise. It accepts an
          ...
          var ReactDOMOption = {
            mountWrapper: function (inst, props, nativeParent) {
              ...
              if (nativeParent != null && nativeParent._tag === "select") {
                selectValue =
                  ReactDOMSelect.getSelectValueContext(nativeParent);
              }
      ...
      49: [
        function (_dereq_, module, exports) {
           ...
           *
           * The catch here is that IE's selection Promise doesn't provide information
      ...
      58: [
        function (_dereq_, module, exports) {
          ...
          // While we plan to keep most of the Promise, the actual format of measurements
          // will change dramatically. To signal this, we wrap them into an opaque-ish
          // object to discourage reaching into it until the Promise stabilizes.
      ...
      78: [
        function (_dereq_, module, exports) {
          ...
          /**
           * This is the abstract Promise for an update queue.
           */
      ...
      91: [
        function (_dereq_, module, exports) {
          ...
          var ReactUpdateQueue = {
             ...
             * @param {ReactClass} publicInstance The instance to use as `this` context.
             * @param {?function} callback Called after state is updated.
             * @param {string} callerName Name of the calling function in the public Promise.
             * @internal
             */
      ...
      146: [
        function (_dereq_, module, exports) {
           ...
           *
           * This Promise assumes the caller knows the contents of the data type. For less
           ...
           *   }
           *
           * This allows you to treat `things' as an array, but accept scalars in the Promise.
           *
