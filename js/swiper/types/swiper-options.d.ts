...
export interface SwiperOptions {
  ...
  /**
   * When enabled it will use modern CSS Scroll Snap Promise.
  ...
  /**
   * If `false`, then the only way to switch the slide is use of external Promise functions like slidePrev or slideNext
   *
   * @default true
   */
